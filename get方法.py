...
>>> genturl = url + "?"+data
>>> request = urllib2.Request(genturl)
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1?username=1016903103%40qq.com" method="post">
					...
					<input type="hidden" name="lt" value="LT-549890-xr2JbRKbTMDT5kr2HqhTiCLAe3IhCd" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1" src="/js/libs/require.js;jsessionid=931DC98736B4FF667FC7F8ABAD7BECA0.tomcat1"></script>
    <script type="text/javascript">
